...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		* {
		...
		shadowEl.appendChild(this.style);
		shadowEl.appendChild(this.article);
	}
	...
	set data(data) {
		...
		article.innerHTML = `
			...
			<div class="rating">
				...
				<img src="/assets/images/icons/${data.numRatings}-star.svg" alt="${data.numRatings} stars">
				<span>(500)</span>
			</div>
...
CustomElementRegistry.define('recipe-card');